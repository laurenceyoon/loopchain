...
class BlockManager:
    ...
    def __init__(self, name: str, channel_service, peer_id, channel_name, store_identity):
        ...
        self.blockchain = BlockChain(channel_name, store_identity, self.__txQueue)
    ...
    def confirm_prev_block(self, current_block: Block):
        confirmed_block = self.blockchain.confirm_prev_block(current_block, self.candidate_blocks, self.epoch.complained_result)
